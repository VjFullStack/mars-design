...
// Fallback values for production if environment variables are not set
const spaceId = process.env.CONTENTFUL_SPACE_ID || 'bysj21yidh60';
const accessToken = process.env.CONTENTFUL_ACCESS_TOKEN || '5xpHJYg3aqrCbaarzKh6jutfOcvpp3BgO0jYMsgIQS0';
